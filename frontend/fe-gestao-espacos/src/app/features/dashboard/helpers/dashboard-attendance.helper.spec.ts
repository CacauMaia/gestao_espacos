...
describe('dashboard attendance helpers', () => {
  const attendances: Attendance[] = [
    { id: '1', userId: 'monitor-1', spaceId: 'lab', entryAt: '', exitAt: null },
    { id: '2', userId: 'student-1', spaceId: 'lab', entryAt: '', exitAt: null },
    { id: '3', userId: 'student-2', spaceId: 'library', entryAt: '', exitAt: null },
  ];
